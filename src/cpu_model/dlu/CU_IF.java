...
//MIPS
public class CU_IF extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_IF() {
		//CU_IF.Op=op, CU_IF.IRFunc=irfunc |- CU_IF.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_IF", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_IF", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_IF", a, b, c);
		Proof.add(f, j);
