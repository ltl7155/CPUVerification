...
//MIPS
public class CU_WB extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_WB() {
		//CU_WB.Op=op, CU_WB.IRFunc=irfunc |- CU_WB.Func=func
		...
		//CU_WB.Op=op, CU_WB.IRFunc=irfunc |- CU_WB.Func=func, CU_WB.MemDataSelFunc=mds_func
		...
		//CU_WB.Op=op |- CU_WB.Func=func, CU_WB.MemDataSelFunc=mds_func
		...
		//CU_WB.Op=op, CU_WB.AA=aa, CU_WB.LK=lk |- CU_WB.Func=func		
		...
		//CU_WB.Op=op, CU_WB.IRFunc2=irfunc2 |- CU_WB.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_WB", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_WB", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_WB", a, b, c);
		Proof.add(f, j);
