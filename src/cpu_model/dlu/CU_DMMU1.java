...
//MIPS
public class CU_DMMU1 extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_DMMU1() {
		//CU_DMMU1.Op=op, CU_DMMU1.IRFunc=irfunc |- CU_DMMU1.Func=func
		...
		//CU_DMMU1.Op=op, CU_DMMU1.IRFunc=irfunc |- CU_DMMU1.Func=func, CU_DMMU1.MemDataSelFunc=mds_func
		...
		//CU_DMMU1.Op=op |- CU_DMMU1.Func=func	
		...
		//CU_DMMU1.Op=op |- CU_DMMU1.Func=func, CU_DMMU1.MemDataSelFunc=mds_func
		...
		//CU_DMMU1.Op=op, CU_DMMU1.AA=aa, CU_DMMU1.LK=lk |- CU_DMMU1.Func=func		
		...
		//CU_DMMU1.Op=op, CU_DMMU1.IRFunc2=irfunc2 |- CU_DMMU1.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_DMMU1", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_DMMU1", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_DMMU1", a, b, c);
		Proof.add(f, j);
