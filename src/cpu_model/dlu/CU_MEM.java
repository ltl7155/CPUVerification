...
//MIPS
public class CU_MEM extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_MEM() {
		//CU_MEM.Op=op, CU_MEM.IRFunc=irfunc |- CU_MEM.Func=func
		...
		//CU_MEM.Op=op, CU_MEM.IRFunc=irfunc |- CU_MEM.Func=func, CU_MEM.MemDataSelFunc=mds_func
		...
		//CU_MEM.Op=op |- CU_MEM.Func=func, CU_MEM.MemDataSelFunc=mds_func
		...
		//CU_MEM.Op=op, CU_MEM.AA=aa, CU_MEM.LK=lk |- CU_MEM.Func=func		
		...
		//CU_MEM.Op=op, CU_MEM.IRFunc2=irfunc2 |- CU_MEM.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_MEM", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_MEM", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_MEM", a, b, c);
		Proof.add(f, j);
