...
//MIPS
///*
public class IR_DMMU2 extends DLU {
	...
	private void _IR_DMMU2_Hold() {
		
//		IR_DMMU2-Hold	
//		_[IR_DMMU2]=data, CtrlIR_DMMU2=0 |- [IR_DMMU2]=data
		...
		Justification j = new Justification("IR_DMMU2-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_DMMU2_Write() {
		//IR_DMMU2-Write	IR_DMMU2.In=inst, CtrlIR_DMMU2=1 |- [IR_DMMU2]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_DMMU2-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_DMMU2_Out() {
		//IR_DMMU2-Out
		...
		Procedure a = reg.getLastContent();
		j = new Justification("IR_DMMU2-Out", a);
