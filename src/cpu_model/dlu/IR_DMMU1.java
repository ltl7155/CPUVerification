...
//MIPS
///*
public class IR_DMMU1 extends DLU {
	...
	private void _IR_DMMU1_Hold() {
		
//		IR_DMMU1-Hold	
//		_[IR_DMMU1]=data, CtrlIR_DMMU1=0 |- [IR_DMMU1]=data
		...
		Justification j = new Justification("IR_DMMU1-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_DMMU1_Write() {
		//IR_DMMU1-Write	IR_DMMU1.In=inst, CtrlIR_DMMU1=1 |- [IR_DMMU1]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_DMMU1-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_DMMU1_Out() {
		//IR_DMMU1-Out
		...
		Procedure a = reg.getLastContent();
		j = new Justification("IR_DMMU1-Out", a);
