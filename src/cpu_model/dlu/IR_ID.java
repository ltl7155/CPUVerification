...
//MIPS
///*
public class IR_ID extends DLU {
	...
	private void _IR_ID_Hold() {
		
//		IR_ID-Hold	
//		_[IR_ID]=data, CtrlIR_ID=0 |- [IR_ID]=data
		...
		Justification j = new Justification("IR_ID-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_ID_Write() {
		//IR_ID-Write	IR_ID.In=inst, CtrlIR_ID=1 |- [IR_ID]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_ID-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_ID_Out() {
		//IR-Out
