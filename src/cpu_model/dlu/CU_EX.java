...
//MIPS
public class CU_EX extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_EX() {
		//CU_EX.Op=op, CU_EX.IRFunc=irfunc |- CU_EX.Func=func
		...
		//CU_EX.Op=op, CU_EX.IRFunc=irfunc |- CU_EX.Func=func, CU_EX.MemDataSelFunc=mds_func
		...
		//CU_EX.Op=op |- CU_EX.Func=func, CU_EX.MemDataSelFunc=mds_func
		...
		//CU_EX.Op=op, CU_EX.AA=aa, CU_EX.LK=lk |- CU_EX.Func=func		
		...
		//CU_EX.Op=op, CU_EX.IRFunc2=irfunc2 |- CU_EX.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_EX", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_EX", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_EX", a, b, c);
		Proof.add(f, j);
