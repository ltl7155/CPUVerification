...
//MIPS
public class CU_DMMU2 extends DLU {
...
//	MMU��Cache��ض˿�
	private DataPort IMMUHit;
	private DataPort ICacheHit;
	private DataPort ICacheHitOut;
	private DataPort IMMUHitOut;
	private DataPort DMMUHit;
	private DataPort DMMUHitOut;
	private DataPort DCacheHit;
	private DataPort DCacheHitOut;
	private DataPort ICacheWriteBack;
	private DataPort DCacheWriteBack;
//	��ˮ����ض˿�
	private DataPort Halt;
	private DataPort Bub;
...
//		MMU��Cache��ض˿�
		IMMUHit = addDataPort(this, name + ".IMMUHit");
		ICacheHit = addDataPort(this, name + ".ICacheHit");
		DMMUHit = addDataPort(this, name + ".DMMUHit");
		DMMUHitOut = addDataPort(this, name + ".DMMUHitOut");
		DCacheHit = addDataPort(this, name + ".DCacheHit");
		DCacheHitOut = addDataPort(this, name + ".DCacheHitOut");
		ICacheWriteBack = addDataPort(this, name + ".ICacheWriteBack");
		DCacheWriteBack = addDataPort(this, name + ".DCacheWriteBack");
		ICacheHitOut = addDataPort(this, name + ".ICacheHitOut");
		IMMUHitOut = addDataPort(this, name + ".IMMUHitOut");
		
//		��ˮ����ض˿�
		Halt = addDataPort(this, name + ".Halt");
		Bub = addDataPort(this, name + ".Bub");
	}
	...
	private void _CU_DMMU2() {
		//CU_DMMU2.Op=op, CU_DMMU2.IRFunc=irfunc |- CU_DMMU2.Func=func
		...
		//CU_DMMU2.Op=op, CU_DMMU2.IRFunc=irfunc |- CU_DMMU2.Func=func, CU_DMMU2.MemDataSelFunc=mds_func
		...
		//CU_DMMU2.Op=op |- CU_DMMU2.Func=func	
		...
		//CU_DMMU2.Op=op |- CU_DMMU2.Func=func, CU_DMMU2.MemDataSelFunc=mds_func
		...
		//CU_DMMU2.Op=op, CU_DMMU2.AA=aa, CU_DMMU2.LK=lk |- CU_DMMU2.Func=func		
		...
		//CU_DMMU2.Op=op, CU_DMMU2.IRFunc2=irfunc2 |- CU_DMMU2.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_DMMU2", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_DMMU2", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_DMMU2", a, b, c);
		Proof.add(f, j);
