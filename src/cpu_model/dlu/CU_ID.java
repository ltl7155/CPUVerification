...
//MIPS
public class CU_ID extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_ID() {
		//CU_ID.Op=op, CU_ID.IRFunc=irfunc |- CU_ID.Func=func
		...
		//CU_ID.Op=op, CU_ID.IRFunc=irfunc |- CU_ID.Func=func, CU_ID.MemDataSelFunc=mds_func
		...
		//CU_ID.Op=op |- CU_ID.Func=func, CU_ID.MemDataSelFunc=mds_func
		...
		//CU_ID.Op=op, CU_ID.AA=aa, CU_ID.LK=lk |- CU_ID.Func=func		
		...
		//CU_ID.Op=op, CU_ID.IRFunc2=irfunc2 |- CU_ID.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_ID", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_ID", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_ID", a, b, c);
		Proof.add(f, j);
