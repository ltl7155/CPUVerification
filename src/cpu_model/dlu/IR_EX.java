...
//MIPS
///*
public class IR_EX extends DLU {
	...
	private void _IR_EX_Hold() {
		
//		IR_EX-Hold	
//		_[IR_EX]=data, CtrlIR_EX=0 |- [IR_EX]=data
		...
		Justification j = new Justification("IR_EX-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_EX_Write() {
		//IR_EX-Write	IR_EX.In=inst, CtrlIR_EX=1 |- [IR_EX]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_EX-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_EX_Out() {
		//IR_EX-Out
		...
		Procedure a = reg.getLastContent();
		j = new Justification("IR_EX-Out", a);
