...
//MIPS
public class CU_IMMU extends DLU {
...
//		��ˮ����ض˿�
	...
	private void _CU_IMMU() {
		//CU_IMMU.Op=op, CU_IMMU.IRFunc=irfunc |- CU_IMMU.Func=func
		...
		//CU_IMMU.Op=op, CU_IMMU.IRFunc=irfunc |- CU_IMMU.Func=func, CU_IMMU.MemDataSelFunc=mds_func
		...
		//CU_IMMU.Op=op |- CU_IMMU.Func=func	
		...
		//CU_IMMU.Op=op |- CU_IMMU.Func=func, CU_IMMU.MemDataSelFunc=mds_func
		...
		//CU_IMMU.Op=op, CU_IMMU.AA=aa, CU_IMMU.LK=lk |- CU_IMMU.Func=func		
		...
		//CU_IMMU.Op=op, CU_IMMU.IRFunc2=irfunc2 |- CU_IMMU.Func=func
	...
	private void op_func(String str_op, String str_irfunc, String str_func) {
		...
		Justification j = new Justification("CU_IMMU", a, b);
		Proof.add(f, j);
	...
	private void op(String str_op, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_IMMU", a);
		Proof.add(f, j);
	...
	private void op_aa_lk(String str_op, String str_aa, String str_lk, String str_func) {
		...
		Formula f = new PortDataFormula(Func, func);
		Justification j = new Justification("CU_IMMU", a, b, c);
		Proof.add(f, j);
