...
//MIPS
///*
public class IR_WB extends DLU {
	...
	private void _IR_WB_Hold() {
		
//		IR_WB-Hold	
//		_[IR_WB]=data, CtrlIR_WB=0 |- [IR_WB]=data
		...
		Justification j = new Justification("IR_WB-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_WB_Write() {
		//IR_WB-Write	IR_WB.In=inst, CtrlIR_WB=1 |- [IR_WB]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_WB-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_WB_Out() {
		//IR_WB-Out
