...
//MIPS
///*
public class IR_MEM extends DLU {
	...
	private void _IR_MEM_Hold() {
		
//		IR_MEM-Hold	
//		_[IR_MEM]=data, CtrlIR_MEM=0 |- [IR_MEM]=data
		...
		Justification j = new Justification("IR_MEM-Hold", a, b);
		Proof.add(f, j);
	}
	
	private void _IR_MEM_Write() {
		//IR_MEM-Write	IR_MEM.In=inst, CtrlIR_MEM=1 |- [IR_MEM]=inst	
		...
		Formula f = new RegContentFormula(reg, data);
		Justification j = new Justification("IR_MEM-Write", a, b);
		Proof.add(f, j);		
	}
	
	private void _IR_MEM_Out() {
		//IR_MEM-Out
		...
		Procedure a = reg.getLastContent();
		j = new Justification("IR_MEM-Out", a);
